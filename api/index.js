...
const {networkList}  =  require('../network')
const {base_url} = networkList

mongoose
  .connect("mongodb+srv://sahusuneel:pass123@cluster0.cynhzzg.mongodb.net/", {
    useNewUrlParser: true,
    useUnifiedTopology: true,
  })
  .then(() => {
    console.log("Connected to MongoDB");
    app.listen(port, '0.0.0.0', () => {  //make your server listen only after successful db connection.
...
const sendVerificationEmail = async (email, verificationToken) => {
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "suneelsahu777@gmail.com",
      pass: "rytusekokjvwabil",
    },
  });

  const mailOptions = {
    from: "suneelsahu777@gmail.com",
    to: email,
