...
// console.log("33",base_url)
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      console.log("error fetching user profile",`${base_url}/profile/${userId}`, error);
    }
  };
  useEffect(() => {
    const fetchAllPosts = async () => {
      try {
        ...
        console.log("error fetching posts",`${base_url}/all`, error);
      }
    };
    fetchAllPosts();
  });
            ...
            >
              <Pressable onPress={() => handleLikePost(item?._id)}>
                <AntDesign
                  ...
                  name="like2"
                  size={24}
                  color={isLiked? "#0072b1" : "gray"}  //Add item?.likes?.length
                />
                <Text
                  style={{
                    textAlign: "center",
                    fontSize: 12,
                    color: isLiked? "#0072b1" : "gray", // item?.likes?.length
                    marginTop: 2,
                  }}
                >
                  Like
